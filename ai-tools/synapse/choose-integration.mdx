...
<CardGroup cols={1}>
  <Card title="Embed widget" icon="code" href="/ai-tools/synapse/embed/quickstart">
  ...
  <Card title="React SDK" icon="react" href="/ai-tools/synapse/react/installation">
  ...
  <Card title="Core SDK" icon="cube" href="/ai-tools/synapse/core/quickstart">

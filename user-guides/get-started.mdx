...
<Steps>
    ...
    <Step title="AUTHENTICATION">
        ...
        **How to Authenticate with EKA’s API**
        <Columns cols={3}>
                <div className="eka-card-wrapper">
                    <Card title="1. Get Access Token" href="/api-reference/authorization/refresh-token">
                    <p style={{ fontSize: '13px', color: '#475569', lineHeight: '1.45' }}>
                ...
                <div className="eka-card-wrapper">
                    <Card title="2. Use Access Token" href="/api-reference/authorization/refresh-token">
                    <p style={{ fontSize: '13px', color: '#475569', lineHeight: '1.45' }}>
                ...
                <div className="eka-card-wrapper">
                    <Card title="3. Handle Token Expiration" href="/api-reference/authorization/refresh-token">
                    <p style={{ fontSize: '13px', color: '#475569', lineHeight: '1.45' }}>

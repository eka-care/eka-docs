...
- **IP Allowlisting:**
For security and reliable delivery of webhook events, please allowlist the following Eka Care AWS IP addresses on your infrastructure. This ensures that only requests from Eka Care's servers are accepted by your webhook endpoint.
...
- Even without a digital signature, always implement additional security measures such as IP allowlisting and HTTPS to secure your webhook endpoint.

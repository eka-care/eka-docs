...
<Tip>
Refer to the [list component](/api-reference/health-ai/assessment/component-info/list-all-components) documentation for different question compoent response format. 
</Tip>

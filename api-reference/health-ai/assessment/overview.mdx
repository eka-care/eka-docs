...
You will get multiple error codes in case of any failure. You can refer to the [error codes](/api-reference/health-ai/assessment/error-codes) for more details.

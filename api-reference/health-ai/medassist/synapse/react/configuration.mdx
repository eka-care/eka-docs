...
`MedAssistConfig` is the optional third argument to [`renderMedAssist`](/api-reference/health-ai/medassist/synapse/react/installation#api). Every field is optional — anything you omit falls back to the agent config you set in [console.eka.care](https://console.eka.care).
...
<ParamField path="theme" type="object">
  Brand colors and styling. See [Theming & design system](/api-reference/health-ai/medassist/synapse/react/theming).
</ParamField>

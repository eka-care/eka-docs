...
1. **[Embed widget](/api-reference/health-ai/medassist/synapse/embed/quickstart)** — the easiest path, for any website.
...
2. **[React SDK](/api-reference/health-ai/medassist/synapse/react/installation)** — the prebuilt UI, for React apps.
...
3. **[Core SDK](/api-reference/health-ai/medassist/synapse/core/quickstart)** — full control, for custom UIs.

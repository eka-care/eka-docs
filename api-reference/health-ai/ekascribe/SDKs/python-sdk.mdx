...
**[Python SDK (`scribe-python-sdk`)](/api-reference/health-ai/ekascribe/SDKs/scribe-python-sdk)**,
built on the [MedScribeAlliance Protocol](/api-reference/health-ai/ekascribe/protocol/overview),

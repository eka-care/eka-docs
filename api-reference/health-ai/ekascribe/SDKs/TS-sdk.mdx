...
**Recommended:** Use **[ngrok](/api-reference/health-ai/ekascribe/local-development-ngrok)** to give your local server a public HTTPS URL and test against the production `baseUrl` directly.

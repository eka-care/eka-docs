...
After successfully uploading your audio files, proceed to [Initialize Transaction](/api-reference/health-ai/ekascribe/ekascribe-v2/init) to start the transcription process.

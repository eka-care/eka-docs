...
<Warning>These EkaScribe v2 transaction-based APIs are deprecated. Please use the new [EkaScribe Protocol APIs](/api-reference/health-ai/ekascribe/protocol/overview) (Create Session → Upload Audio → End Session) or the [SDKs](/api-reference/health-ai/ekascribe/quick-start) instead.</Warning>

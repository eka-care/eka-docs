---
title: "Overview (Deprecated)"
icon: "triangle-exclamation"
---

<Warning>These EkaScribe v2 transaction-based APIs are deprecated. Please use the new [EkaScribe Protocol APIs](/ekascribe/api-reference/sessions/overview) (Create Session → Upload Audio → End Session) or the [SDKs](/ekascribe/quickstart) instead.</Warning>
...
- **General Overview**: [EkaScribe Main Documentation →](/ekascribe/overview)
- **SDK Options**: Looking for easier integration? Check out our [SDKs →](/ekascribe/overview#integration-products)

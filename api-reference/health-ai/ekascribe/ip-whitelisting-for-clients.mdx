...
> Ensure your network/firewall is configured to allow inbound connections from the above IPs and URLs for seamless integration with Eka Scribe & audio transcription APIs.

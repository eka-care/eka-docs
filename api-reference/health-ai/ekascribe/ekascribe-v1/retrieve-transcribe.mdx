...
<Warning>This API is deprecated. Please use the [EkaScribe v2 APIs](/api-reference/health-ai/ekascribe/ekascribe-v2/overview) or the [SDKs](/ekascribe/quickstart) instead.</Warning>

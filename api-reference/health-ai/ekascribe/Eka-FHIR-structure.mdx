...
| Eka Property | FHIR Resource | FHIR Link | Decision to Use |
|--------------|---------------|-----------|-----------------|
| medication.name, medication.id | MedicationRequest.medicationCodeableConcept | [Medication Codes](https://www.hl7.org/fhir/valueset-medication-codes.html) | Name : paracetamol 500 mg; code: MDB, SNOMED |
...
| medication.frequency.frequency, frequency.period, frequency.period_unit | MedicationRequest.dosageInstruction.timing.repeat,duration, duration-unit, when | [Timing](https://www.hl7.org/fhir/datatypes.html#Timing) | frequency, period, periodUnit |

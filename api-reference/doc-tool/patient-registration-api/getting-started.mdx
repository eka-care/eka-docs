...
<Note> Right now adding a patient is done in reference to a specific doctor, which automatically adds the patient to the business directory as well. Adding patient directly to a business is WIP and adding via doctor_id will be deprecated. </Note>
</Step>

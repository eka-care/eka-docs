...
5. **Edit/Delete/Reschedule Appointments:**
...
**Note**: You can also create an appointment without adding the patient first. Providing patient details while creating an appointment adds the patient to the directory automatically.
</Step>

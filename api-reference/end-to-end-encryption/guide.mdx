...
```
<Note>
    For tasks such as `PII` or `SRP`, make sure to include the appropriate query parameter as described in the [Upload API](https://developer.eka.care/api-reference/health-ai/medical-document-parsing/upload-report).
</Note>

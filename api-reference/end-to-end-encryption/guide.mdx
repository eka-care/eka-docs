...
encrypted_jwe = encrypt_jwe(payload, "YOUR_SECRET_KEY")
print(encrypted_jwe)
```
...
public class Program
{
    ...
    public static void Main()
    {
        ...
        var encrypted_jwe = EncryptJwe(payload, "YOUR_SECRET_KEY");
...
print(decrypt_jwe(encrypted_jwe, "YOUR_SECRET_KEY"))
```
...
public class Program
{
    ...
    public static void Main()
    {
        ...
        Console.WriteLine(DecryptJwe(encrypted_jwe, "YOUR_SECRET_KEY"));
    }
}
```

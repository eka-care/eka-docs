...
description: >
  ...
  This API is only needed if you are **not** storing health data on Eka servers. For the full M2 flow, see the [Care Contexts Overview](/api-reference/user-app/abdm-connect/care-contexts/getting-started).
---
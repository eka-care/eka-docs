...
description: >
  ...
  This API is only needed if you are **not** storing health data on Eka servers. [Care Contexts Overview](/api-reference/user-app/abdm-connect/care-contexts/getting-started).
---
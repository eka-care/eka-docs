...
Enables health data exchange between Health Information Providers (HIPs) and Health Information Users (HIUs). The flow starts with linking care contexts and ends with sharing encrypted health data upon consent.

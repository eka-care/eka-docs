...
description: >
  This is the starting point of the ABDM M2 flow. Use this API to link a care context to the patient's ABHA address. A care context represents a visit, test, or any logical grouping of health records.

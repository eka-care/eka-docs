...
<Note>
After receiving this webhook, search your system for matching unlinked care contexts and respond by calling the [On Discover API](/api-reference/user-app/abdm-connect/care-contexts/discover/on_discover).
</Note>

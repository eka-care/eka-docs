...
<Steps>
    <Step title="Generate Scan & Share Token">
        Use the [Request to generate token](/api-reference/user-app/abdm-connect/scan-and-share/phr-scan-share) API to
        scan a QR code from a hospital or clinic, then [Get appointment token](/api-reference/user-app/abdm-connect/scan-and-share/phr-scan-share-token)
        to fetch the facility's response.
    </Step>
</Steps>
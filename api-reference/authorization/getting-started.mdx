...
<Note>
<a href="https://login.eka.care/workspace/sign-in/?next=https://dr.eka.care/app/init&product_type=emr&signup=user_only&post_sign_up=https://onboarding.eka.care&tab=sign-up" target="_blank">Click here to visit Eka signup page to get started</a>.
</Note>
...
to create and manage API client credentials.
...
to generate an access token and start making API requests.

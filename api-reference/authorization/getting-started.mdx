...
<Steps>
  ...
  <Step title="Automatic Account Creation and Login">
    ...
    <img
      ...
      alt="Eka Developer Console after signup"
      data-zoomable
    />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Copy Long Live Token">
    ...
    <Step title="Using Long Lived Token">
      Include the access token in the Authorization header of every API request to authenticate and access Eka’s services.
  </Step>
</Steps>

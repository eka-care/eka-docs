...
// Electron
new MedicalRecordsClient({ transport: TransportMode.Bridge, cache: {}, defaultHeaders: {...} })

// Browser
new MedicalRecordsClient({ transport: TransportMode.Native, cache: {}, defaultHeaders: {...} })
```

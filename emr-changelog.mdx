...
<Update
  ...
  rss={{
    ...
    description: "• LMP-EDD and Ultrasound-EDD calculators now accept today's date — the date validation switched from `<` to `<=`, fixing a false-positive \"cannot be in the future\" error\n\nRead more: https://developer.eka.care/emr-changelog"
  }}
>

...
<Update
  ...
  rss={{
    ...
    description: "Ophthalmology tables in prescription PDFs and the Eka MCP Server now available on Smithery."
  }}
>
...
<Update
  ...
  rss={{
    ...
    description: "IPD billing PDF generation for clinics and conditional visibility controls in the Medical Records Android SDK."
  }}
>

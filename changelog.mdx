...
<Update
  label="April 3, 2026"
  description="Week of March 31"
  tags={["Update"]}
  rss={{
    title: "Eka Developer Platform — April 3, 2026",
    description: "• _meta field support in doctor discovery and availability tools — The MCP SDK now passes _meta context to the doctor_discovery and doctor_availability tools, enabling richer agent interactions.\n\nRead more: https://developer.eka.care/changelog"
  }}
>
...
<Update
  ...
  tags={["Feature", "Update"]}
  rss={{
    title: "Eka Developer Platform — April 2, 2026",
    description: "• ABHA login and profile tools in MCP SDK — Agents can now initiate ABHA login, verify OTP, select a profile, and retrieve the ABHA card.\n\n• More ophthalmology tables in prescription PDFs — Pachymetry, Amsler grid, and contact lens examination tables are now included in prescription PDFs.\n\nRead more: https://developer.eka.care/changelog"
  }}
>
...
<Update
  ...
  tags={["Update", "Fix"]}
  rss={{
    title: "Eka Developer Platform — March 31, 2026",
    description: "• MedAssist iOS background session handling — Chat sessions now stay connected when switching apps.\n\n• Bug fix: MedAssist iOS error handling — Error messages are now surfaced clearly instead of failing silently.\n\nRead more: https://developer.eka.care/changelog"
  }}
>

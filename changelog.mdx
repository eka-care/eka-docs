...
<Update
  ...
  rss={{
    ...
    description: "• MedAssist web widget adds contextual popups for in-context AI suggestions\n\n• Agent ID handling fixed in MedAssist web widget\n\n• Nudge notifications disabled in MedAssist web widget\n\nRead more: https://developer.eka.care/changelog"
  }}
>
...
- **[Platform] Usage metrics SDK v0.1.1** — The Eka Usage SDK now ships with corrected test configuration and TypeScript module transformation support, improving build reliability for integrators consuming the package.

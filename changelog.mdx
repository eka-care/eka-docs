...
<Update
  ...
  rss={{
    ...
    description: "• Eka MCP Server renamed to Eka EMR MCP Server across all documentation\n\nRead more: https://developer.eka.care/changelog"
  }}
>

## Changed

- **[EkaAgents] Eka MCP Server renamed to Eka EMR MCP Server** — All documentation references to "Eka MCP Server" have been updated to "Eka EMR MCP Server" to better reflect the server's focus on EMR-specific healthcare workflows. Navigation labels, page titles, and cross-references across the MCP Server, Echo Agent Kit, and MCP introduction pages are updated accordingly. [View docs](/ai-tools/mcp-server/introduction)
...
<Update
  ...
  rss={{
    ...
    description: "• ABDM Consent Management Web SDK — embeddable widget for requesting, tracking, and acting on ABDM health data consents\n\nRead more: https://developer.eka.care/changelog"
  }}
>

## Added

- **[Platform] ABDM Consent Management Web SDK** — A new embeddable web widget for ABDM health data consent management is now documented. The SDK enables applications to request, track, and act on ABDM (M3) consents on behalf of patients. It supports consent request creation with configurable date ranges, expiry, purpose, and record types, a consent history table with lifecycle status tracking, and a callback mechanism for viewing records in your own application. [View docs](/SDKs/web-sdk/consent-management/get-started)

...
<Warning>
This legacy `ekacare` Python SDK is **deprecated**. Use the new
**[Python SDK (`scribe-python-sdk`)](/ekascribe/sdks/scribe-python-sdk)**,
built on the [MedScribeAlliance Protocol](/ekascribe/api-reference/sessions/overview),
for new integrations. This page remains for existing users.
</Warning>
...
- [API Reference for Ekascribe](https://developer.eka.care/ekascribe/api-reference/sessions/overview)

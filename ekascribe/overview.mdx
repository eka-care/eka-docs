...
Or use the **copy / ChatGPT / Claude** buttons on any page. A prompt like *"Integrate EkaScribe using the docs at developer.eka.care — record a consultation and show the clinical note"* is enough for an agent to build a working integration.

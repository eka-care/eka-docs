...
const result = await ekascribe.getSessionStatus(start.txn_id, {
  poll: { maxAttempts: 60, intervalMs: 2000 },
});
```

Available for [TypeScript](/ekascribe/sdks/ekascribe-ts-sdk), [Python](/ekascribe/sdks/scribe-python-sdk), [Java](/ekascribe/sdks/java-sdk), [Android](/ekascribe/sdks/android-sdk) and [iOS](/ekascribe/sdks/ios-sdk).

...
Use the returned `template_id` in [Create Session](/ekascribe/api-reference/sessions/create-session) or [Convert Notes](/ekascribe/api-reference/templates/convert-notes).
